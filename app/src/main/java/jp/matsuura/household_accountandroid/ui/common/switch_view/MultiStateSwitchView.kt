...
import jp.matsuura.household_accountandroid.ext.dp2px
import jp.matsuura.householda_ccountandroid.R
import timber.log.Timber
import java.lang.Math.abs

// Num of states used in editor preview
private const val DEFAULT_NUM_STATES = 2
...
class MultiStateSwitchView @JvmOverloads constructor(
    context: Context,
    ...
    private fun populateStates() {
        ...
        for (i in states.indices) {
            try {
                ...
                Timber.e("asdf", "populateStates()", e)
            }
        }
    }
    ...
    private fun createStateDrawable(
        ...
        val stateTV = TextView(context).apply {
            ...
            if (shadow) {
                background = (this@MultiStateSwitchView.background.constantState!!.newDrawable().mutate() as GradientDrawable).apply {
